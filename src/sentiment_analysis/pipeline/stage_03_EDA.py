...
class DataEDAPipeline:
    ...
    def run_pipeline(self,preprocessed_data):
        """
        Executes the EDA component.
        
        Args:
            preprocessed_data: Tuple containing raw texts and labels for train, val, and test sets.
        """
        try:
            ...
            # 2. Get raw data
            raw_train_texts = preprocessed_data.raw_train_texts
            raw_train_labels = preprocessed_data.raw_train_labels
            raw_val_texts = preprocessed_data.raw_val_texts
            raw_val_labels = preprocessed_data.raw_val_labels
